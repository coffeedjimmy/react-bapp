...
export const setCount = (count, setQrvalue) => {
  ...
  export const setDoubleCount = (count, setQrvalue) => {
    axios
      .post(A2P_API_PREPARE_URL, {
        bapp: {
          name: APP_NAME,
        ...
        transaction: {
            to: CONTRACT_ADDR,
            abi: '{ "constant": false, "inputs": [ { "name": "_count", "type": "uint256" } ], "name": "setDoubleCount", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function" }',
            value: "0",  // klay
            params: `[\"${count}"\]`
        }
      })
